...
def get_mmlu_accuracy(model, tokenizer, network=None, data_dir='data/mmlu/test', batch_size = 5, dtype = torch.bfloat16, verbose=False, log_subclasses=False):
...
def get_hp_accuracy(model, tokenizer, network=None, batch_size = 5, dtype = torch.bfloat16, verbose=False, data_path = 'data/harrypotter_eva/hp-questions-dual.json'):
    corrects = {}
    for data_path in ([
                        data_path,
                      ]):
